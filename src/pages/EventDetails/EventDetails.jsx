...
export const EventDetails = () => {
  return (
    <section>
      ...
      <div
        className="bg-[url('https://dgu.ac/thumb/1400x560/images/header-images/life-at-dgu/college-fest/4.jpg')] bg-center aspect-video md:aspect-[4/1] bg-cover bg-no-repeat relative header w-full"
        >
        ...
        <div className="absolute flex max-md:flex-col justify-between items-center px-[5%] bottom-0 left-0 right-0 z-20  bg-gradient-to-t from-black to-transparent text-white">
          ...
          <h2 className="text-5xl text-amber-300  mt-6 md:text-6xl font-semibold max-md:text-center">
